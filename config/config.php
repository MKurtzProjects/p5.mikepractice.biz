...
# What is the name of this app?
	define('APP_NAME', 'Share Stuff');  

# When email is sent out from the server, where should it come from?
# Ideally, this should match the domain name
	define('APP_EMAIL', 'michaelkurtz10@gmail.com'); 
...
*/ 	
	define('SYSTEM_EMAIL', 'michaelkurtz10@gmail.com'); 

# Default DB name for this app
	define('DB_NAME', 'mikeprac_p3_biz'); 
...
# For this you could use gmail SMTP or something like http://sendgrid.com/
	...
	define('PASSWORD_SALT', '0u7Exjw%#^gfx!E%qC3AHr!tWeksVj&_3URAg2)#haBq(JjL$41KyZ3cDJI$SYVz');
	define('TOKEN_SALT', 'PR&4^X3Zihihg8tfRpaBdLTLll2LDMHcF0sWdpftZ%Tm2uQX%Xlu5%Bw6QybFNeM');